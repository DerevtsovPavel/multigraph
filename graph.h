...
public:
	...
	///Поиск минимального пути от узла со значением inf, до всех остальных. Если вершина не достижима, то будет значение inf(infinity). Вернётся указатель на узел, в векторе edges - вершины в графе, в векторе weight - длина пути до соответствующей вершины из edges
